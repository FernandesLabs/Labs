...
export function ConsentManager() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl flex-col gap-3 rounded-xl border border-border/70 bg-card p-4 shadow-2xl sm:flex-row sm:items-center sm:gap-4 sm:p-5">
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            className="rounded-lg border border-border/70 px-4 py-2 text-xs font-medium text-foreground transition hover:bg-muted"
          >
            Reject
          </button>
          <button
